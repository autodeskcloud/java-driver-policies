...
public class LatencyAndInflightCountLoadBalancingPolicyTest extends BasicLoadBalancingPolicyQueryPlanTest {
    ...
    protected BasicLoadBalancingPolicy createAndInitPolicy() {
        ...
        BasicLoadBalancingPolicy policy =
                spy(
                        new LatencyAndInflightCountLoadBalancingPolicy(context, DriverExecutionProfile.DEFAULT_NAME) {
                            @Override
